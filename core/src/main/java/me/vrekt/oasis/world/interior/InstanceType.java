...
public enum InstanceType {
    ...
    DEFAULT {
        @Override
        public Instance createInstance(OasisGame game, OasisPlayer player, OasisWorld world, String name, String cursor, Rectangle bounds) {
    ...
    public abstract Instance createInstance(OasisGame game, OasisPlayer player, OasisWorld world, String name, String cursor, Rectangle bounds);

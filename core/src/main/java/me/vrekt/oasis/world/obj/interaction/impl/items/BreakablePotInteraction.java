 ...
 */
public final class BreakablePotInteraction extends AbstractInteractableWorldObject {
    ...
    public BreakablePotInteraction(GameWorld world, MapObject object) {
        super(WorldInteractionType.BREAKABLE_POT);
        ...
        if (anim != null) {
            ...
            breakingAnimation = new Animation<>(0.1335f, frames);
        }
    }
    ...
    public void interact() {
        ...
        GameManager.playSound(Sounds.POT_BREAKING, 1.0f, 0.88f, 0.0f);

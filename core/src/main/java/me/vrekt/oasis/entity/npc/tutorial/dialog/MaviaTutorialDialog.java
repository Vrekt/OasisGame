...
public final class MaviaTutorialDialog {
    ...
    public static InteractableEntityDialog create() {
        final InteractableEntityDialog dialog = EntityDialogBuilder.builder()
                ...
                .next()
                .create("mavia_dialog_4", "Go over there to the three [GREEN]chests. [WHITE]Open each one and take the items out.")
                ...
                .next()
                .create("mavia_dialog_8", "Now, to consume the fruit press [GREEN]" + Input.Keys.toString(OasisKeybindings.INVENTORY_KEY) + " [WHITE]to open your inventory.")

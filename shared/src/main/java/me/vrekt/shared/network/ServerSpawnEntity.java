 ...
 */
public final class ServerSpawnEntity extends Packet {
    ...
    public ServerSpawnEntity(int entityId, EntityType type, Vector2 position) {
        this.entityId = entityId;
        this.type = type;
        this.position = position;
    }

    public ServerSpawnEntity(ByteBuf buffer) {
        super(buffer);
    }
